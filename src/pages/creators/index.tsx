      ...
      <div className={s.content}>
        <div className={s.sectionOne}>
          <div className={s.sectionContent}>
            ...
            <div className={s.text}>Unlock the full potential of language models with MLChain, make it intuitive and quick for both professional and non-developers to design, build, and deploy operational AI applications. We are striving to be the best open source LLMOps platform.</div>
          </div>
        </div>
        <div className={s.sectionTwo}>
          ...
          <div className={s.sectionTwoContent}>
            <div className={s.teamIntro}>
              ...
              <div className={s.introText}>The core members of MLChain come from Tencent Cloud's DevOps platform, where we were once the cream of the crop. With over 6 years of R&D experience in DevOps, developer tools, and productivity tools, we're on a mission to leverage cutting-edge technology as our cornerstone, making AI applications easy to use and develop with a touch of love and humor.</div>
            </div>
            ...
            <div className={s.thanks}>The growth of MLChain wouldn't be possible without the support of open-source communities like GitHub, especially our contributors. A special shoutout to <a className={s.link} target="_blank" rel="noreferrer" href="https://www.apidog.com">Apidog</a> for their invaluable help.</div>
          </div>
        </div>
          ...
          <div className={s.sectionFourContent}>
            ...
            <div className={s.contactCards}>
              <div className={s.contactCard}>
                ...
                <div className={s.contactText}>Please communicate with us through Discord or participate in building MLChain by submitting GitHub issues.</div>
                <div className={s.extraLinks}>
                  <div className={s.linkItem}>
                    <div className={s.logoGithub}/>
                    <a className={s.extraLink} target="_blank" rel="noreferrer" href="https://github.com/mlchain/mlchain">GitHub</a>
                  </div>
                  <div className={s.linkItem}>
              ...
              <div className={s.contactCard}>
                ...
                <div className={s.extraLinks}>
                  <div className={s.linkItem}>
                    <a href="mailto:hello@khulnasoft.com" className={s.extraLinkActive}>hello@khulnasoft.com</a>
                  </div>
                </div>
              </div>
            </div>
