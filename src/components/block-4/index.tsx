...
const Block4 = () => {
  ...
  const lastMode = {
    title: t("更多模型支持中"),
    content: t(
      "除了 OpenAI 的 GPT 系列，MLChain 将陆续支持更多大型语言模型。请向我们反馈，或在开源社区参与开发。"
    ),
    btn: t("告诉我们你想要什么"),
    link:
      local === "en"
        ? "https://docs.mlchain.khulnasoft.com/en/advanced/model-configuration"
        : "https://docs.mlchain.khulnasoft.com/zh-hans/advanced/model-configuration",
  };
  return (
