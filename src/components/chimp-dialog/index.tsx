...
const chimpUrl = 'https://mlchain.us12.list-manage.com/subscribe/post-json?u=9fe281ea555091f91d5183066&id=668e3674f6&f_id=00de6ee0f0&tags=10504697&b_9fe281ea555091f91d5183066_668e3674f6=&subscribe=Subscribe'
        ...
        {formState === 'filling' ? (
          <>
            ...
            <form className={style.form}>
              ...
              <p className={style.tip}>{t('提交此表单，即代表您同意接收 MLChain 发送的产品资讯邮件')}</p>
            </form>
          </>
        ) : (
          <>
            ...
            <p className={style.intro}>{formState === 'success' ? t('感谢对 MLChain 的关注。') : t('该邮箱已登记过了，请耐心等待。')}</p>
