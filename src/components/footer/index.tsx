...
const Footer = () => {
  ...
  const list1 = [
    {
      text: t('Blog'),
      props: {
        href: `https://blog.mlchain.github.io`,
        target: '_blank',
        rel: 'noreferrer',
      },
    },
    {
      text: t('Support'),
      props: {
        href: `https://docs.mlchain.khulnasoft.com${
  ...
  const list2 = [
    ...
    },
    {
      ...
      key: "Status OK",
      props: {
        href: 'http://mlchain.statuspage.io',
        target: '_blank',
        rel: 'noreferrer',
      },
    },
  ...
  return (
    <div className={s.container}>
      <div className={s.top}>
        <div className={s.brand}>
          ...
          <div className={s.text}>
            {t(
              'MLChain is progressing to become the best open source LLMOps platform.'
            )}
          </div>
        </div>
        <div className={s.nav}>
      ...
      <div className={s.bottom}>
        <div className={s.copywrite}>© 2023 KhulnaSoft, Ltd. </div>
